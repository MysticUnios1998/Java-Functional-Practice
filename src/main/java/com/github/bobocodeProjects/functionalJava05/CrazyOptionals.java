package com.github.bobocodeProjects.functionalJava05;
...
import com.github.bobocodeProjects.functionalJava05.funcional.AccountProvider;
import com.github.bobocodeProjects.functionalJava05.funcional.AccountService;
import com.github.bobocodeProjects.functionalJava05.funcional.CreditAccountProvider;
...
public class CrazyOptionals {
    ...
    public static void deposit(AccountProvider accountProvider, BigDecimal amount) {
        accountProvider.getAccount()
        	.ifPresent(acc -> acc.setBalance(acc.getBalance().add(amount)));
    }
    ...
    public static Optional<Account> retrieveAccountGmail(AccountProvider accountProvider) {
        return accountProvider.getAccount()
        		.filter(acc -> acc.getEmail().matches("^.+@gmail.+$"));
    }
