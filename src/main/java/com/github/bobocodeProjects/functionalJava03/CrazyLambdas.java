package com.github.bobocodeProjects.functionalJava03;
...
public class CrazyLambdas {
    ...
    public static BiFunction<String, Integer, String> stringMultiplier() {
        return (string, repeats) -> {
        	if (repeats < 0) throw new IllegalArgumentException();
    ...
    public static Function<BigDecimal, String> toDollarStringFunction() {
        return (bigDecimal) -> {
        	if (bigDecimal.intValue() < 0) throw new IllegalArgumentException();
    ...
    public static Function<Runnable, Supplier<Thread>> runnableToThreadSupplierFunction() {
        return (runnable) -> runningThreadSupplier(runnable);
    }
    ...
    public static BiFunction<Map<String, IntUnaryOperator>, String, IntUnaryOperator> functionLoader() {
        return (map, funcName) -> map.getOrDefault(funcName, IntUnaryOperator.identity());
    }
